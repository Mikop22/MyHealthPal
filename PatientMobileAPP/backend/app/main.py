...
# CORS: honour ALLOWED_ORIGINS env var for production; fall back to localhost regex for dev.
...
if _allowed_raw == "*":
    ...
    # Default: allow any localhost / 127.0.0.1 origin (any port) for local dev
